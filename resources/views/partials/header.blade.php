<header id="header" class="header">
  ...
  <a href="<?php echo home_url(); ?>">
    <svg id="header__logo-svg" class="header__logo-svg" viewBox="0 0 225.2 270.3">
      ...
      <path class="st0 rubZJJkj_2" d="M113.3,56.9L113.3,56.9c-21.4-21.4-55.9-21.4-77.3,0s-21.4,55.9,0,77.3s55.9,21.4,77.3,0v0c21.4-21.4,55.9-21.4,77.3,0c21.4,21.4,21.4,55.9,0,77.3s-55.9,21.4-77.3,0l0,0" />
    </svg>
  </a>
  </h1>
  <!-- //hamburger menu// -->
